            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h4 class="card-title"><?= isset($disciplina) ? 'Atualizar' : 'Nova' ?> Disciplina</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="<?= url_to('deletarDisciplina', esc($disciplina['id_disciplina'])) ?>" class="btn btn-danger btn-sm">Deletar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
